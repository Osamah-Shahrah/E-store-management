...
<div class="lockscreen-wrapper">
  ...
  <?php if(isset($_SESSION['user_icon'])!=""){  ?>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="../../img/user/<?php echo $_SESSION['user_icon'] ?>" alt="<?php echo $_SESSION['username']; ?>">
    </div>
    <?php }
    else{
      echo"  <!-- User name -->
  ...
  <div class='lockscreen-item'>
    ...
    <div class="input-group">
       <input type="email" name="user_n_or_phon" id="user_n_or_phon" readonly value="<?php echo$_SESSION['username'] ?>">
